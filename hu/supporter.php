...
return [
    ...
    'nameIcon' => 'Név ikon',
    'nameIconDesc' => 'Válassz egyet a 10 ikon közül (beleértve az országod zászlaját), amely a neved előtt jelenik meg.',
    'emotes' => 'Emoteok a chatben',
    'emotesDesc' => 'Beírva a <code>:</code> szót a jstris chatbe megnyílik az emote-kiválasztás, amelyen keresztül több mint 2000 elérhető érzelmet választhatsz ki az Openmoji könyvtárból.',
    'discord' => 'Jstris Discord rang',
    'discordDesc' => 'Narancssárga név a Jstris Discord szerveren. Csak akkor alkalmazható, ha a Discord-fiókod összekapcsolod a Jstris-szel.',
    'list' => 'Név a Támogatók listáján',
    'listDesc' => 'A Támogatók listáján a játékbeli profilodra mutató link fog szerepelni. A beállításokban kikapcsolható.',

    'customColor' => 'Egyéni szín a chaten',
    'customColorDesc' => 'Bármilyen színt beállíthatsz a nevedre a színválasztó eszközzel.',
    'moreIcons' => 'Több mint 2000 név ikon',
    ...
    'monthlyActive' => 'Jelenleg aktív :type előfizetésed van.',
    'customActive' => 'Az adomány összege alapján az :type jutalmak :days napig elérhetőek.',

    //configuration
    'gift' => 'Jutalmak ajándékozása',
    'ingameIcon' => 'Játékbeli ikon',
    'countryFlag' => 'Országzászló',
    'iconEmote' => 'Egyéni emote mint játékbeli ikon',
    'iconEmoteDesc' => 'Kezdj el gépelni a kereséshez. Az emote nevek teljes listájáért látogasson el a :linkre.',
    'randIcon' => 'Véletlenszerűen új ikont választ ki minden alkalommal, amikor a játék betöltődik',
    'chatColor' => 'Egyéni játékbeli szín',
    'supporterList' => 'A Támogatók listáján feltűntetett név',
    'roleAdded' => 'Hozzáadva a :name néven csatlakoztatott Discord-fiókhoz.',
    'addDiscord' => 'Add hozzá a Discord-fiókod <a href=":link">a Jstris fiókbeállításokban</a> az engedélyezés előtt.',
