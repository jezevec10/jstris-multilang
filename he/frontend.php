...
return [
    ...
    'refr' => 'מרענן את הדף',
    'lines' => 'שורות',
    'statistics' => 'סטטיסטיקה', //stat lines showing under the field
    'vs' => 'VS', //label for VS score stat
    'downstack' => 'פינוי זבל',
    'wasted' => 'בוזבז',
    'expand' => 'הרחב',  //tooltip for icon to expand chat
    ...
    'noBlocks' => 'אין עוד קוביות',
    'noBlocks2' => 'כל הקוביות נוצלו',
    ...
    //friends
    'fr' => 'חברים',
    'frLoad' => 'טוען רשימת חברים',
    'frLogin' => 'התחבר תחילה כדי להשתמש ברשימת החברים',
    'frEmpty' => 'רשימת החברים ריקה',
    'frHowAdd' => 'בקרו בפרופיל המשתמש כדי לשלוח בקשת חברות.',
    'frPriv' => 'פרטי',
    'frIn' => 'כבר בפנים!',
    'frChat' => 'פתח צ׳אט',
    'frRel' => 'רענן',
    'frMsgTo' => 'הודעה אל {name}',  //keep {name}
    'frInv' => 'שלח הזמנה לחדר',
    'frInvTo' => 'הזמנה להצטרף ל־{room}',
    'frInvIn' => 'את/ה כבר בפנים!',
    'frInvBy' => 'מאת {user}',
    'frOn' => 'מחובר',
    'frOff' => 'מנותק',
    'frNewChatH' => 'תחילת היסטוריית הצ׳אט עם {name}.',
    'frWelc' => 'ברוך/ה הבא/ה ללשונית חברים',
    'frIntro' => 'כאן אפשר לגשת לרשימת חברים מחוברים, לצ׳אטים פרטיים ולהזמנות לחדרים',
    'frIntro2' => 'כדי לשלוח בקשת חברות, בקר/י בפרופיל המשתמש',
    'frIntro3' => 'כדי לנהל חברים, בקר/י ב־{frPage}',
    'frPage' => 'דף חברים',
    'frIntroCl' => 'סגור הקדמה',
];
