...
return [
    ...
    'noBlocks' => '残っているブロックがありません',
    'noBlocks2' => 'すべてのブロックが使用されました',
    ...
    //friends
    'fr' => 'フレンド',
    'frLoad' => 'フレンド一覧を読み込んでいます',
    'frLogin' => 'フレンドリストを使用するにはログインしてください',
    'frEmpty' => 'フレンドリストが空です',
    'frHowAdd' => 'ユーザーのプロフィールにアクセスしてフレンド申請をしてみましょう．',
    'frPriv' => 'プライベート',
    'frIn' => '同じ場所に居ます!',
    'frChat' => 'チャットを開く',
    'frRel' => '再読み込み',
    'frMsgTo' => '{name} へのメッセージ',  //keep {name}
    'frInv' => 'ルームに招待を送る',
    'frInvTo' => '{room} に参加する',
    'frInvIn' => '既に参加しています!',
    'frInvBy' => '{user} から',
    'frOn' => 'オンライン',
    'frOff' => '・オフライン',
    'frNewChatH' => '{name}とのチャットの先頭です.',
    'frWelc' => 'フレンドタブへようこそ',
    'frIntro' => 'このタブではオンラインの友達，プライベートチャット，部屋への招待を確認できます',
    'frIntro2' => 'フレンドリクエストを送るにはユーザーのプロフィールにアクセスしてください',
    'frIntro3' => 'フレンドを管理するには {frPage}にアクセスしてください',
    'frPage' => 'フレンドページ',
    'frIntroCl' => '説明を閉じる',
];
