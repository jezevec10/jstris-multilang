...
return [
    ...
    'signingIn' => '로그인 중',
    'loginFail' => '로그인 실패!',
    'loginFail2' => '로그인이 되 있지 않습니다! {name} 이름의 게스트로 플레이 중입니다.',
    'mapLoading' => '맵 불러오는중...',
    'oldVer2' => '구 버전을 사용 중입니다! {key}키를 눌러 클라이언트를 다시 불러오세요.',
    'roomFull' => '방이 꽉 찬 것 같습니다.',
    'lobbyInfo' => '이 채팅은 {discord} 와 공유중입니다.'
    'newHost' => '당신은 이제 이 방의 호스트입니다.',
    'badRoom' => '이 방은 더 이상 존재하지 않습니다, 기본 방으로 입장합니다!',
    'stngsChanged' => '설정이 호스트에 의해 변경됨',
    'stngsCustom' => '커스텀 세팅',
    'aSpec' => '이미 관전중입니다!',
    'aPlay' => '이미 플레이중입니다!',
    'repFail' => '리플레이 저장에 실패하였습니다.',
    'repInChat' => '리플레이 파일이 채팅에 남아있습니다. 보존하려면, 텍스트를 복사해 당신의 텍스트 에디터로 붙여 넣어주세요.',
    'repTxtInfo' => '복사된 리플레이 파일은 리플레이에서 재생하거나 사이트에 다시 올릴 수 있습니다.',
];
